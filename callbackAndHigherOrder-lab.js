...
// const first = (array, callBack) => callBack (names[0])
...
const last = (array, callBack) => callBack (names[array.length - 1])
...
const uniq (array3, callBack) 

const uniq = function hasUniqueChars(word) {
